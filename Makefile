...
build/thesis.pdf: paper.org preamble.tex paperTemplate.latex
	pandoc -o paper.pdf --template=paperTemplate.latex --latex-engine=xelatex -H preamble.tex --bibliography bibliography.bib --csl=plos.csl -V geoometry:margin=1.25in paper.org
